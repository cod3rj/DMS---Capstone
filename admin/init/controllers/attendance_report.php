<?php
		...
		$stmt = $conn->prepare("SELECT * FROM attendance a INNER JOIN tbl_students b ON a.student_qrcode = b.qr_code WHERE a.logdate BETWEEN ? AND ? ORDER BY a.attendance_id ASC");
